...
@RestControllerAdvice(assignableTypes = {
        nbcc.resto.controller.EventController.class
})
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDuplicate(DuplicateEventNameException ex) {
        return buildError(HttpStatus.CONFLICT, ex.getMessage());
    }

    @ExceptionHandler(InvalidEventException.class)
    public ResponseEntity<Map<String, Object>> handleInvalid(InvalidEventException ex) {
